...
-- LSP
map('n','<Leader>ld', '<cmd>Telescope lsp_document_diagnostics<CR>', { silent = true})
...
map('n','<Leader>rca', '<cmd>Telescope lsp_range_code_actions<CR>', { silent = true})
map('n','<Leader>gr', '<cmd>Telescope lsp_references<CR>', { silent = true})

map('n', '<leader>ne', '<cmd>lua vim.lsp.diagnostic.goto_next { wrap = true }<CR>')
...
map('n', '<leader>gi', '<cmd>lua vim.lsp.buf.implementation()<CR>', {silent = true})
map('n', '<leader>h', '<cmd>lua vim.lsp.buf.hover()<CR>', {silent = true})
